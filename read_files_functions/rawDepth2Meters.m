...
function meterDepth = rawDepth2Meters(rawDepth)
rawDepth = double(rawDepth);
meterDepth = zeros(size(rawDepth));

meterDepth(rawDepth<1025) = 1.0 ./ (rawDepth(rawDepth<1025) * -0.0030711016 + 3.3309495161);
